...
<body>
    <div class="container relative  min-h-screen m-auto my-3 sm:my-10 max-w-screen-desktop">
        <div x-data="users_table()" id="user__list">
            <div class="px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-xl font-semibold text-gray-900">Пользователи</h1>
                        <p class="mt-2 text-sm text-gray-700">Список всех пользователей в вашей учетной записи, включая
                            их имя, должность</p>
                    </div>
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col"
                                            ...
                                            Имя</th>
                                        <th scope="col"
                                            class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Фамилия
                                        </th>
                                        <th scope="col"
                                            class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900">Должность
                                        </th>
                                        ...
                                        <template x-for="user in users">
                                            <tr>
                                                ...
                                                <td x-text="user.position"
                                                    class="whitespace-nowrap py-4 px-3 text-sm text-gray-500">Front-end
                                                    Developer</td>
                                                <td
    ...
    <div x-cloak="" x-show="false" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <!--
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    ...
                                    name="first_name" type="text" placeholder="Jane">
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <input
                                    ...
                                    type="text" placeholder="Doe" name="last_name">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
